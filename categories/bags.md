...
<div class="p-4">
  <h1 class="text-3xl font-bold mb-2">Bags</h1>
  <p class="text-accent mb-6">Explore our collection of upcycled bags</p>

  <div class="grid grid-cols-2 gap-4">
    {% assign bags_products = site.products | where: "category", "bags" %}
    {% for product in bags_products %}
